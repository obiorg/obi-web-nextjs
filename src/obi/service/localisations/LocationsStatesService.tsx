...
// Define the shape of the form errors LocationsStates
interface LocationsStatesFormErrors {
    id?: string[];
    deleted?: string[];
    created?: string[];
    changed?: string[];
...
interface LocationsStatesFormState {
    errors: LocationsStatesFormErrors;
}

// Define the props that the PostForm component expects
interface LocationsStatesPostFormProps {
...
interface LocationsStatesPostFormState {
    errors: {
        id?: string[];
        deleted?: string[];
        created?: string[];
...
export const LocationsStatesService = {
    ...
    async getById(id: any) {
        const url = process.env.httpPath + '/localisations/states/' + id;
        try {
            const res = await fetch(url, { headers: { 'Cache-Control': 'no-cache' } })
            if (res.ok) {
                const val = await res.json();
     ...
     */
    async create(
        formState: LocationsStatesFormState,
        formData: FormData | any): Promise<LocationsStatesFormState> {
        ...
        const dataset: LocationsStatesFormState = await res.json();
        return dataset;
    ...
    async createMany(data: any[]): Promise<any[]> {
        ...
        const url = process.env.httpPath + '/localisations/states/create';
    ...
    async update(
        ...
        const url = process.env.httpPath + '/localisations/states/' + data.id;
    ...
    async updateMany(
        ...
        const url = process.env.httpPath + '/localisations/states/update';
        // console.log(data);
        const res = await fetch(
            url,
            {
    ...
    async delete(id: any): Promise<LocationsStatesFormState> {
    ...
    async deleteMany(
        ...
        const url = process.env.httpPath + '/localisations/states/delete';
        // console.log(data);
        const res = await fetch(
            url,
            {
    ...
    async download(lazy: any): Promise<any[]> {
        const url = process.env.httpPath + '/localisations/states/download/' + lazy.lazyEvent;
        const res = await fetch(url, { headers: { 'Cache-Control': 'no-cache' } })
        const dataset: any[] = await res.json();
        return dataset;
    },
