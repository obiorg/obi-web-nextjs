...
interface MeasuresLimitsDropDownProps {
    value: any;
...
export default function MeasuresLimitsDropDown({
    ...
    useEffect(() => {
        if (initCatalog === false) {
            ...
            // Get Lazy Data
            MeasuresLimitsService.getLazy(lazyEventSet).then((data: any) => {
