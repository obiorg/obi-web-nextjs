...
import { UsersRolesModel } from "../../models/users/UsersRolesModel";




    // Define the shape of the form errors UsersRoles
    interface UsersRolesFormErrors {
        id?: string[];
        deleted?: string[];
        created?: string[];
        changed?: string[];
    ...
    interface UsersRolesFormState {
        errors: UsersRolesFormErrors;
    }

    // Define the props that the PostForm component expects
    interface UsersRolesPostFormProps {
    ...
    interface UsersRolesPostFormState {
        errors: {
            id?: string[];
            deleted?: string[];
            created?: string[];
...
export const UsersRolesService = {
    ...
    async getLazy(lazy: any): Promise<any> {
        const url = process.env.httpPath + '/users/roles/lazy/' + lazy.lazyEvent;
    ...
    async getLazyCount(lazy: any) {
        const url = process.env.httpPath + '/users/roles/lazy/count/' + lazy.lazyEvent;
        try {
            const res = await fetch(url, { headers: { 'Cache-Control': 'no-cache' } })
            if (res.ok) {
    ...
    async getById(id: any) {
        const url = process.env.httpPath + '/users/roles/' + id;
        try {
            const res = await fetch(url, { headers: { 'Cache-Control': 'no-cache' } })
            if (res.ok) {
                const val = await res.json();
    ...
    defaultMultiSortMeta(): any {
        const model = new UsersRolesModel();
     ...
     */
    async create(
        formState: UsersRolesFormState,
        formData: FormData | any): Promise<UsersRolesFormState> {
        ...
        const url = process.env.httpPath + '/users/roles';
        ...
        const dataset: UsersRolesFormState = await res.json();
        return dataset;
    ...
    async processAll(formState: any, datas: any): Promise<any> {
        ...
        datas.forEach((row:any, index:any) => {
            UsersRolesService.create(formState, row).then((res_row) => {
    ...
    async createMany(data: any[]): Promise<any[]> {
        ...
        const url = process.env.httpPath + '/users/roles/create';
    ...
    async update(
        ...
        const url = process.env.httpPath + '/users/roles/' + data.id;
    ...
    async updateMany(
        ...
        const url = process.env.httpPath + '/users/roles/update';
        // console.log(data);
        const res = await fetch(
            url,
            {
    ...
    async delete(id: any): Promise<UsersRolesFormState> {
    ...
    async deleteMany(
        ...
        const url = process.env.httpPath + '/users/roles/delete';
        // console.log(data);
        const res = await fetch(
            url,
            {
    ...
    async download(lazy: any): Promise<any[]> {
        const url = process.env.httpPath + '/users/roles/download/' + lazy.lazyEvent;
        const res = await fetch(url, { headers: { 'Cache-Control': 'no-cache' } })
        const dataset: any[] = await res.json();
        return dataset;
    },
