...
import { AlarmsRendersModel } from "../../models/alarms/AlarmsRendersModel";




    // Define the shape of the form errors AlarmsRenders
    interface AlarmsRendersFormErrors {
        id?: string[];
        deleted?: string[];
        created?: string[];
        changed?: string[];
    ...
    interface AlarmsRendersFormState {
        errors: AlarmsRendersFormErrors;
    }

    // Define the props that the PostForm component expects
    interface AlarmsRendersPostFormProps {
    ...
    interface AlarmsRendersPostFormState {
        errors: {
            id?: string[];
            deleted?: string[];
            created?: string[];
...
export const AlarmsRendersService = {
    ...
    async getLazy(lazy: any): Promise<any> {
        const url = process.env.httpPath + '/alarms/renders/lazy/' + lazy.lazyEvent;
    ...
    async getLazyCount(lazy: any) {
        const url = process.env.httpPath + '/alarms/renders/lazy/count/' + lazy.lazyEvent;
        try {
            const res = await fetch(url, { headers: { 'Cache-Control': 'no-cache' } })
            if (res.ok) {
    ...
    async getById(id: any) {
        const url = process.env.httpPath + '/alarms/renders/' + id;
        try {
            const res = await fetch(url, { headers: { 'Cache-Control': 'no-cache' } })
            if (res.ok) {
                const val = await res.json();
    ...
    defaultMultiSortMeta(): any {
        const model = new AlarmsRendersModel();
     ...
     */
    async create(
        formState: AlarmsRendersFormState,
        formData: FormData|any): Promise<AlarmsRendersFormState> {
        ...
        const url = process.env.httpPath + '/alarms/renders';
        ...
        const dataset: AlarmsRendersFormState = await res.json();
        return dataset;
    ...
    async processAll(formState: any, datas: any): Promise<any> {
        ...
        datas.forEach((row:any, index:any) => {
            AlarmsRendersService.create(formState, row).then((res_row) => {
    ...
    async createMany(data: any[]): Promise<any[]> {
        ...
        const url = process.env.httpPath + '/alarms/renders/create';
    ...
    async update(
        formState: AlarmsRendersFormState,
        formData: FormData): Promise<AlarmsRendersFormState> {
        ...
        const url = process.env.httpPath + '/alarms/renders/' + data.id;
    ...
    async updateMany(
        ...
        const url = process.env.httpPath + '/alarms/renders/update';
        // console.log(data);
        const res = await fetch(
            url,
            {
    ...
    async delete(id: any): Promise<AlarmsRendersFormState> {
    ...
    async deleteMany(
        ...
        const url = process.env.httpPath + '/alarms/renders/delete';
        // console.log(data);
        const res = await fetch(
            url,
            {
    ...
    async download(lazy: any): Promise<any[]> {
        const url = process.env.httpPath + '/alarms/renders/download/' + lazy.lazyEvent;
        const res = await fetch(url, { headers: { 'Cache-Control': 'no-cache' } })
        const dataset: any[] = await res.json();
        return dataset;
    },
