...
export const TagsListTypeService = {
    ...
    async getLazy(lazy: any): Promise<any> {
        const url = process.env.httpPath + '/tags/listtype/lazy/' + lazy.lazyEvent;
    ...
    async getLazyCount(lazy: any) {
        const url = process.env.httpPath + '/tags/listtype/lazy/count/' + lazy.lazyEvent;
        try {
            const res = await fetch(url, { headers: { 'Cache-Control': 'no-cache' } })
            if (res.ok) {
    ...
    defaultMultiSortMeta(): any {
        const model = new TagsListTypeModel();
    ...
    async create(
        ...
        formData: FormData): Promise<TagsListTypeFormState> {
    ...
    async deleteMany(
        ...
        const url = process.env.httpPath + '/tags/listtype/delete';
        // console.log(data);
        const res = await fetch(
            url,
            {
    ...
    async download(lazy: any): Promise<any[]> {
        const url = process.env.httpPath + '/tags/listtype/download/' + lazy.lazyEvent;
        const res = await fetch(url, { headers: { 'Cache-Control': 'no-cache' } })
        const dataset: any[] = await res.json();
        return dataset;
    },
