...
defaultMultiSortMeta(): any {
    const model = new PersistenceStandardModel();
 ...
 */
async create(
    formState: OBI.PersistencesStandardFormState,
    formData: FormData): Promise<OBI.PersistencesStandardFormState> {
    ...
    const dataset: OBI.PersistencesStandardFormState = await res.json();
...
async delete(id: any): Promise<OBI.PersistencesStandardFormState> {
