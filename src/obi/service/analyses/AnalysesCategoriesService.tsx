...
import { AnalysesCategoriesModel } from "../../models/analyses/AnalysesCategoriesModel";




    // Define the shape of the form errors AnalysesCategories
    interface AnalysesCategoriesFormErrors {
        id?: string[];
        deleted?: string[];
        created?: string[];
        changed?: string[];
    ...
    interface AnalysesCategoriesFormState {
        errors: AnalysesCategoriesFormErrors;
    }

    // Define the props that the PostForm component expects
    interface AnalysesCategoriesPostFormProps {
    ...
    interface AnalysesCategoriesPostFormState {
        errors: {
            id?: string[];
            deleted?: string[];
            created?: string[];
...
export const AnalysesCategoriesService = {
    ...
    async getLazy(lazy: any): Promise<any> {
        const url = process.env.httpPath + '/analyses/categories/lazy/' + lazy.lazyEvent;
    ...
    async getLazyCount(lazy: any) {
        const url = process.env.httpPath + '/analyses/categories/lazy/count/' + lazy.lazyEvent;
        try {
            const res = await fetch(url, { headers: { 'Cache-Control': 'no-cache' } })
            if (res.ok) {
    ...
    async getById(id: any) {
        const url = process.env.httpPath + '/analyses/categories/' + id;
        try {
            const res = await fetch(url, { headers: { 'Cache-Control': 'no-cache' } })
            if (res.ok) {
                const val = await res.json();
    ...
    defaultMultiSortMeta(): any {
        const model = new AnalysesCategoriesModel();
     ...
     */
    async create(
        formState: AnalysesCategoriesFormState,
        formData: FormData | any): Promise<AnalysesCategoriesFormState> {
        ...
        const url = process.env.httpPath + '/analyses/categories';
        ...
        const dataset: AnalysesCategoriesFormState = await res.json();
        return dataset;
    ...
    async processAll(formState: any, datas: any): Promise<any> {
        ...
        datas.forEach((row:any, index:any) => {
            AnalysesCategoriesService.create(formState, row).then((res_row) => {
    ...
    async createMany(data: any[]): Promise<any[]> {
        ...
        const url = process.env.httpPath + '/analyses/categories/create';
    ...
    async update(
        ...
        const url = process.env.httpPath + '/analyses/categories/' + data.id;
    ...
    async updateMany(
        ...
        const url = process.env.httpPath + '/analyses/categories/update';
        // console.log(data);
        const res = await fetch(
            url,
            {
    ...
    async delete(id: any): Promise<AnalysesCategoriesFormState> {
    ...
    async deleteMany(
        ...
        const url = process.env.httpPath + '/analyses/categories/delete';
        // console.log(data);
        const res = await fetch(
            url,
            {
    ...
    async download(lazy: any): Promise<any[]> {
        const url = process.env.httpPath + '/analyses/categories/download/' + lazy.lazyEvent;
        const res = await fetch(url, { headers: { 'Cache-Control': 'no-cache' } })
        const dataset: any[] = await res.json();
        return dataset;
    },
