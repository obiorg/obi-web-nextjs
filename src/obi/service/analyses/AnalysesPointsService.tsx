...
import { AnalysesPointsModel } from "../../models/analyses/AnalysesPointsModel";




    // Define the shape of the form errors AnalysesPoints
    interface AnalysesPointsFormErrors {
        id?: string[];
        deleted?: string[];
        created?: string[];
        changed?: string[];
    ...
    interface AnalysesPointsFormState {
        errors: AnalysesPointsFormErrors;
    }

    // Define the props that the PostForm component expects
    interface AnalysesPointsPostFormProps {
    ...
    interface AnalysesPointsPostFormState {
        errors: {
            id?: string[];
            deleted?: string[];
            created?: string[];
...
export const AnalysesPointsService = {
    ...
    async getLazy(lazy: any): Promise<any> {
        const url = process.env.httpPath + '/analyses/points/lazy/' + lazy.lazyEvent;
    ...
    async getLazyCount(lazy: any) {
        const url = process.env.httpPath + '/analyses/points/lazy/count/' + lazy.lazyEvent;
        try {
            const res = await fetch(url, { headers: { 'Cache-Control': 'no-cache' } })
            if (res.ok) {
    ...
    async getById(id: any) {
        const url = process.env.httpPath + '/analyses/points/' + id;
        try {
            const res = await fetch(url, { headers: { 'Cache-Control': 'no-cache' } })
            if (res.ok) {
                const val = await res.json();
    ...
    defaultMultiSortMeta(): any {
        const model = new AnalysesPointsModel();
    ...
    async create(
        ...
        const url = process.env.httpPath + '/analyses/points';
    ...
    async createMany(data: any[]): Promise<any[]> {
        ...
        const url = process.env.httpPath + '/analyses/points/create';
    ...
    async update(
        ...
        const url = process.env.httpPath + '/analyses/points/' + data.id;
    ...
    async updateMany(
        ...
        const url = process.env.httpPath + '/analyses/points/update';
        // console.log(data);
        const res = await fetch(
            url,
            {
    ...
    async delete(id: any): Promise<AnalysesPointsFormState> {
    ...
    async deleteMany(
        ...
        const url = process.env.httpPath + '/analyses/points/delete';
        // console.log(data);
        const res = await fetch(
            url,
            {
    ...
    async download(lazy: any): Promise<any[]> {
        const url = process.env.httpPath + '/analyses/points/download/' + lazy.lazyEvent;
        const res = await fetch(url, { headers: { 'Cache-Control': 'no-cache' } })
        const dataset: any[] = await res.json();
        return dataset;
    },
