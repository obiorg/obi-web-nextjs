...
import { AnalysesAllowedModel } from "../../models/analyses/AnalysesAllowedModel";




    // Define the shape of the form errors AnalysesAllowed
    interface AnalysesAllowedFormErrors {
        id?: string[];
        deleted?: string[];
        created?: string[];
        changed?: string[];
    ...
    interface AnalysesAllowedFormState {
        errors: AnalysesAllowedFormErrors;
    }

    // Define the props that the PostForm component expects
    interface AnalysesAllowedPostFormProps {
    ...
    interface AnalysesAllowedPostFormState {
        errors: {
            id?: string[];
            deleted?: string[];
            created?: string[];
...
export const AnalysesAllowedService = {
    ...
    async getLazy(lazy: any): Promise<any> {
        const url = process.env.httpPath + '/analyses/allowed/lazy/' + lazy.lazyEvent;
    ...
    async getLazyCount(lazy: any) {
        const url = process.env.httpPath + '/analyses/allowed/lazy/count/' + lazy.lazyEvent;
        try {
            const res = await fetch(url, { headers: { 'Cache-Control': 'no-cache' } })
            if (res.ok) {
    ...
    async getById(id: any) {
        const url = process.env.httpPath + '/analyses/allowed/' + id;
        try {
            const res = await fetch(url, { headers: { 'Cache-Control': 'no-cache' } })
            if (res.ok) {
                const val = await res.json();
    ...
    defaultMultiSortMeta(): any {
        const model = new AnalysesAllowedModel();
     ...
     */
    async create(
        formState: AnalysesAllowedFormState,
        formData: FormData|any): Promise<AnalysesAllowedFormState> {
        ...
        const url = process.env.httpPath + '/analyses/allowed';
        ...
        const dataset: AnalysesAllowedFormState = await res.json();
        return dataset;
    ...
    async processAll(formState: any, datas: any): Promise<any> {
        ...
        datas.forEach((row:any, index:any) => {
            AnalysesAllowedService.create(formState, row).then((res_row) => {
    ...
    async createMany(data: any[]): Promise<any[]> {
        ...
        const url = process.env.httpPath + '/analyses/allowed/create';
    ...
    async update(
        formState: AnalysesAllowedFormState,
        formData: FormData): Promise<AnalysesAllowedFormState> {
        ...
        const url = process.env.httpPath + '/analyses/allowed/' + data.id;
    ...
    async updateMany(
        ...
        const url = process.env.httpPath + '/analyses/allowed/update';
        // console.log(data);
        const res = await fetch(
            url,
            {
    ...
    async delete(id: any): Promise<AnalysesAllowedFormState> {
    ...
    async deleteMany(
        ...
        const url = process.env.httpPath + '/analyses/allowed/delete';
        // console.log(data);
        const res = await fetch(
            url,
            {
    ...
    async download(lazy: any): Promise<any[]> {
        const url = process.env.httpPath + '/analyses/allowed/download/' + lazy.lazyEvent;
        const res = await fetch(url, { headers: { 'Cache-Control': 'no-cache' } })
        const dataset: any[] = await res.json();
        return dataset;
    },
