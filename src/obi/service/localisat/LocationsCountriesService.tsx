...
import { LocationsCountriesModel } from "../../models/localisations/LocationsCountriesModel";
    ...
    // Define the shape of the form errors LocationsCountries
    interface LocationsCountriesFormErrors {
        id?: string[];
        deleted?: string[];
        created?: string[];
        changed?: string[];
    ...
    interface LocationsCountriesFormState {
        errors: LocationsCountriesFormErrors;
    }

    // Define the props that the PostForm component expects
    interface LocationsCountriesPostFormProps {
    ...
    interface LocationsCountriesPostFormState {
        errors: {
            id?: string[];
            deleted?: string[];
            created?: string[];
...
export const LocationsCountriesService = {
    ...
    async getById(id: any) {
        const url = process.env.httpPath + '/localisations/countries/' + id;
        try {
            const res = await fetch(url, { headers: { 'Cache-Control': 'no-cache' } })
            if (res.ok) {
                const val = await res.json();
     ...
     */
    async create(
        formState: LocationsCountriesFormState,
        formData: FormData | any): Promise<LocationsCountriesFormState> {
        ...
        const dataset: LocationsCountriesFormState = await res.json();
        return dataset;
    ...
    async processAll(formState: any, datas: any): Promise<any> {
        ...
        datas.forEach((row:any, index:any) => {
            LocationsCountriesService.create(formState, row).then((res_row) => {
    ...
    async createMany(data: any[]): Promise<any[]> {
        ...
        const url = process.env.httpPath + '/localisations/countries/create';
    ...
    async update(
        ...
        const url = process.env.httpPath + '/localisations/countries/' + data.id;
    ...
    async updateMany(
        ...
        const url = process.env.httpPath + '/localisations/countries/update';
        // console.log(data);
        const res = await fetch(
            url,
            {
    ...
    async delete(id: any): Promise<LocationsCountriesFormState> {
    ...
    async deleteMany(
        ...
        const url = process.env.httpPath + '/localisations/countries/delete';
        // console.log(data);
        const res = await fetch(
            url,
            {
    ...
    async download(lazy: any): Promise<any[]> {
        const url = process.env.httpPath + '/localisations/countries/download/' + lazy.lazyEvent;
        const res = await fetch(url, { headers: { 'Cache-Control': 'no-cache' } })
        const dataset: any[] = await res.json();
        return dataset;
    },
