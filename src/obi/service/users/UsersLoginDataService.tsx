...
import { UsersLoginDataModel } from "../../models/users/UsersLoginDataModel";




    // Define the shape of the form errors UsersLoginData
    interface UsersLoginDataFormErrors {
        id?: string[];
        deleted?: string[];
        created?: string[];
        changed?: string[];
    ...
    interface UsersLoginDataFormState {
        errors: UsersLoginDataFormErrors;
    }

    // Define the props that the PostForm component expects
    interface UsersLoginDataPostFormProps {
    ...
    interface UsersLoginDataPostFormState {
        errors: {
            id?: string[];
            deleted?: string[];
            created?: string[];
...
export const UsersLoginDataService = {
    ...
    async getLazy(lazy: any): Promise<any> {
        const url = process.env.httpPath + '/users/logindata/lazy/' + lazy.lazyEvent;
    ...
    async getLazyCount(lazy: any) {
        const url = process.env.httpPath + '/users/logindata/lazy/count/' + lazy.lazyEvent;
        try {
            const res = await fetch(url, { headers: { 'Cache-Control': 'no-cache' } })
            if (res.ok) {
    ...
    async getById(id: any) {
        const url = process.env.httpPath + '/users/logindata/' + id;
        try {
            const res = await fetch(url, { headers: { 'Cache-Control': 'no-cache' } })
            if (res.ok) {
                const val = await res.json();
    ...
    defaultMultiSortMeta(): any {
        const model = new UsersLoginDataModel();
     ...
     */
    async create(
        formState: UsersLoginDataFormState,
        formData: FormData | any): Promise<UsersLoginDataFormState> {
        ...
        const url = process.env.httpPath + '/users/logindata';
        ...
        const dataset: UsersLoginDataFormState = await res.json();
        return dataset;
    ...
    async processAll(formState: any, datas: any): Promise<any> {
        ...
        datas.forEach((row:any, index:any) => {
            UsersLoginDataService.create(formState, row).then((res_row) => {
    ...
    async createMany(data: any[]): Promise<any[]> {
        ...
        const url = process.env.httpPath + '/users/logindata/create';
    ...
    async update(
        ...
        const url = process.env.httpPath + '/users/logindata/' + data.id;
    ...
    async updateMany(
        ...
        const url = process.env.httpPath + '/users/logindata/update';
        // console.log(data);
        const res = await fetch(
            url,
            {
    ...
    async delete(id: any): Promise<UsersLoginDataFormState> {
    ...
    async deleteMany(
        ...
        const url = process.env.httpPath + '/users/logindata/delete';
        // console.log(data);
        const res = await fetch(
            url,
            {
    ...
    async download(lazy: any): Promise<any[]> {
        const url = process.env.httpPath + '/users/logindata/download/' + lazy.lazyEvent;
        const res = await fetch(url, { headers: { 'Cache-Control': 'no-cache' } })
        const dataset: any[] = await res.json();
        return dataset;
    },
