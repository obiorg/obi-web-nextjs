...
import { LocationsCitiesModel } from "../../models/localisations/LocationsCitiesModel";
    ...
    // Define the shape of the form errors LocationsCities
    interface LocationsCitiesFormErrors {
        id?: string[];
        deleted?: string[];
        created?: string[];
        changed?: string[];
    ...
    interface LocationsCitiesFormState {
        errors: LocationsCitiesFormErrors;
    }

    // Define the props that the PostForm component expects
    interface LocationsCitiesPostFormProps {
    ...
    interface LocationsCitiesPostFormState {
        errors: {
            id?: string[];
            deleted?: string[];
            created?: string[];
...
export const LocationsCitiesService = {
    ...
    async getById(id: any) {
        const url = process.env.httpPath + '/localisations/cities/' + id;
        try {
            const res = await fetch(url, { headers: { 'Cache-Control': 'no-cache' } })
            if (res.ok) {
                const val = await res.json();
     ...
     */
    async create(
        formState: LocationsCitiesFormState,
        formData: FormData | any): Promise<LocationsCitiesFormState> {
        ...
        const dataset: LocationsCitiesFormState = await res.json();
        return dataset;
    ...
    async processAll(formState: any, datas: any): Promise<any> {
        ...
        datas.forEach((row:any, index:any) => {
            LocationsCitiesService.create(formState, row).then((res_row) => {
    ...
    async createMany(data: any[]): Promise<any[]> {
        ...
        const url = process.env.httpPath + '/localisations/cities/create';
    ...
    async update(
        ...
        const url = process.env.httpPath + '/localisations/cities/' + data.id;
    ...
    async updateMany(
        ...
        const url = process.env.httpPath + '/localisations/cities/update';
        // console.log(data);
        const res = await fetch(
            url,
            {
    ...
    async delete(id: any): Promise<LocationsCitiesFormState> {
    ...
    async deleteMany(
        ...
        const url = process.env.httpPath + '/localisations/cities/delete';
        // console.log(data);
        const res = await fetch(
            url,
            {
    ...
    async download(lazy: any): Promise<any[]> {
        const url = process.env.httpPath + '/localisations/cities/download/' + lazy.lazyEvent;
        const res = await fetch(url, { headers: { 'Cache-Control': 'no-cache' } })
        const dataset: any[] = await res.json();
        return dataset;
    },
