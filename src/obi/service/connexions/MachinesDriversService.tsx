...
import { MachinesDriversModel } from "../../models/connexions/MachinesDriversModel";




    // Define the shape of the form errors MachinesDrivers
    interface MachinesDriversFormErrors {
        id?: string[];
        deleted?: string[];
        created?: string[];
        changed?: string[];
    ...
    interface MachinesDriversFormState {
        errors: MachinesDriversFormErrors;
    }

    // Define the props that the PostForm component expects
    interface MachinesDriversPostFormProps {
    ...
    interface MachinesDriversPostFormState {
        errors: {
            id?: string[];
            deleted?: string[];
            created?: string[];
...
export const MachinesDriversService = {
    ...
    async getLazy(lazy: any): Promise<any> {
        const url = process.env.httpPath + '/connexions/drivers/lazy/' + lazy.lazyEvent;
    ...
    async getLazyCount(lazy: any) {
        const url = process.env.httpPath + '/connexions/drivers/lazy/count/' + lazy.lazyEvent;
        try {
            const res = await fetch(url, { headers: { 'Cache-Control': 'no-cache' } })
            if (res.ok) {
    ...
    async getById(id: any) {
        const url = process.env.httpPath + '/connexions/drivers/' + id;
        try {
            const res = await fetch(url, { headers: { 'Cache-Control': 'no-cache' } })
            if (res.ok) {
                const val = await res.json();
     ...
     */
    async create(
        formState: MachinesDriversFormState,
        formData: FormData | any): Promise<MachinesDriversFormState> {
        ...
        const url = process.env.httpPath + '/connexions/drivers';
        ...
        const dataset: MachinesDriversFormState = await res.json();
        return dataset;
    ...
    async processAll(formState: any, datas: any): Promise<any> {
        ...
        datas.forEach((row:any, index:any) => {
            MachinesDriversService.create(formState, row).then((res_row) => {
    ...
    async createMany(data: any[]): Promise<any[]> {
        ...
        const url = process.env.httpPath + '/connexions/drivers/create';
    ...
    async update(
        ...
        const url = process.env.httpPath + '/connexions/drivers/' + data.id;
    ...
    async updateMany(
        ...
        const url = process.env.httpPath + '/connexions/drivers/update';
        // console.log(data);
        const res = await fetch(
            url,
            {
    ...
    async delete(id: any): Promise<MachinesDriversFormState> {
    ...
    async deleteMany(
        ...
        const url = process.env.httpPath + '/connexions/drivers/delete';
        // console.log(data);
        const res = await fetch(
            url,
            {
    ...
    async download(lazy: any): Promise<any[]> {
        const url = process.env.httpPath + '/connexions/drivers/download/' + lazy.lazyEvent;
        const res = await fetch(url, { headers: { 'Cache-Control': 'no-cache' } })
        const dataset: any[] = await res.json();
        return dataset;
    },
