...
import { EquipementsExternalProvidersModel } from "../../models/maintenance/EquipementsExternalProvidersModel";




    // Define the shape of the form errors EquipementsExternalProviders
    interface EquipementsExternalProvidersFormErrors {
        id?: string[];
        deleted?: string[];
        created?: string[];
        changed?: string[];
    ...
    interface EquipementsExternalProvidersFormState {
        errors: EquipementsExternalProvidersFormErrors;
    }

    // Define the props that the PostForm component expects
    interface EquipementsExternalProvidersPostFormProps {
    ...
    interface EquipementsExternalProvidersPostFormState {
        errors: {
            id?: string[];
            deleted?: string[];
            created?: string[];
...
export const EquipementsExternalProvidersService = {
    ...
    async getLazy(lazy: any): Promise<any> {
        const url = process.env.httpPath + '/maintenance/equipementsExternalProviders/lazy/' + lazy.lazyEvent;
    ...
    async getLazyCount(lazy: any) {
        const url = process.env.httpPath + '/maintenance/equipementsExternalProviders/lazy/count/' + lazy.lazyEvent;
        try {
            const res = await fetch(url, { headers: { 'Cache-Control': 'no-cache' } })
            if (res.ok) {
    ...
    async getById(id: any) {
        const url = process.env.httpPath + '/maintenance/equipementsExternalProviders/' + id;
        try {
            const res = await fetch(url, { headers: { 'Cache-Control': 'no-cache' } })
            if (res.ok) {
                const val = await res.json();
    ...
    defaultMultiSortMeta(): any {
        const model = new EquipementsExternalProvidersModel();
     ...
     */
    async create(
        formState: EquipementsExternalProvidersFormState,
        formData: FormData | any): Promise<EquipementsExternalProvidersFormState> {
        ...
        const url = process.env.httpPath + '/maintenance/classes';
        ...
        const dataset: EquipementsExternalProvidersFormState = await res.json();
        return dataset;
    ...
    async processAll(formState: any, datas: any): Promise<any> {
        ...
        datas.forEach((row:any, index:any) => {
            EquipementsExternalProvidersService.create(formState, row).then((res_row) => {
    ...
    async createMany(data: any[]): Promise<any[]> {
        ...
        const url = process.env.httpPath + '/maintenance/equipementsExternalProviders/create';
    ...
    async update(
        ...
        const url = process.env.httpPath + '/maintenance/equipementsExternalProviders/' + data.id;
    ...
    async updateMany(
        ...
        const url = process.env.httpPath + '/maintenance/equipementsExternalProviders/update';
        // console.log(data);
        const res = await fetch(
            url,
            {
    ...
    async delete(id: any): Promise<EquipementsExternalProvidersFormState> {
    ...
    async deleteMany(
        ...
        const url = process.env.httpPath + '/maintenance/equipementsExternalProviders/delete';
        // console.log(data);
        const res = await fetch(
            url,
            {
    ...
    async download(lazy: any): Promise<any[]> {
        const url = process.env.httpPath + '/maintenance/equipementsExternalProviders/download/' + lazy.lazyEvent;
        const res = await fetch(url, { headers: { 'Cache-Control': 'no-cache' } })
        const dataset: any[] = await res.json();
        return dataset;
    },
