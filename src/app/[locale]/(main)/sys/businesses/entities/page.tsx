...
const Entities = () => {
    ...
    const [columns, setColumns]: OBI.ColumnMeta[] = useState([
        ...
        { field: 'localisation', header: 'Localisation', dataType: 'numeric', bodyTemplate: templateHelper.localisation, sortable: true, filter: true, filterField: "localisation", showFilterMatchModes: false, filterPlaceholder: 'Chercher une localisation', filterElement: sysComponentsHelper.location_lazyFilter },
    ...
    return (<>
        ...
        <Table
            title='Entités'
            prefix='entities'
            defaultParams={new EntitiesModel().getStandardParam({ field: 'entity', order: 1 }, EntitiesService.defaultFilters())}
            columns={columns}
