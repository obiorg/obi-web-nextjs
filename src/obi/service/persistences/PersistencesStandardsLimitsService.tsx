...
import { PersistencesStandardsLimitsModel } from "../../models/persistences/PersistencesStandardsLimitsModel";




    // Define the shape of the form errors PersistencesStandardsLimits
    interface PersistencesStandardsLimitsFormErrors {
        id?: string[];
        deleted?: string[];
        created?: string[];
        changed?: string[];
    ...
    interface PersistencesStandardsLimitsFormState {
        errors: PersistencesStandardsLimitsFormErrors;
    }

    // Define the props that the PostForm component expects
    interface PersistencesStandardsLimitsPostFormProps {
    ...
    interface PersistencesStandardsLimitsPostFormState {
        errors: {
            id?: string[];
            deleted?: string[];
            created?: string[];
...
export const PersistencesStandardsLimitsService = {
    ...
    defaultMultiSortMeta(): any {
        const model = new PersistencesStandardsLimitsModel();
     ...
     */
    async create(
        formState: PersistencesStandardsLimitsFormState,
        formData: FormData | any): Promise<PersistencesStandardsLimitsFormState> {
        ...
        const dataset: PersistencesStandardsLimitsFormState = await res.json();
        return dataset;
    ...
    async processAll(formState: any, datas: any): Promise<any> {
        ...
        datas.forEach((row:any, index:any) => {
            PersistencesStandardsLimitsService.create(formState, row).then((res_row) => {
