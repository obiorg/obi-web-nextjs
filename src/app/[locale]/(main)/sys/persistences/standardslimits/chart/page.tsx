...
import PersistencesDropDown from '../../components_old/PersistencesDropDownOld';
    ...
    const onSubmit = (e: any) => {
        ...
        loadLazyTimeout = setTimeout(() => {
            ...
            PersistenceStandardService.getLazy(lazyEventSet).then((pers_standard: any) => {
                ...
                let _options = options;
                _options.series[0].data = pers_standard.map((p: OBI.pers_standard) => { return [p.created, p.vFloat]; });
                setOptions(() => { return { ..._options } });
                        ...
                        <div className="col-12 m-0 p-0">
                            ...
                            <div className="grid m-0 p-0 mb-2">
                                ...
                                <Calendar
                                    ...
                                    name='dateTo'
                                    value={dateFrom}
                                    onChange={(e:any) => { console.log(e.value); setDateFrom(e.value) }}
                            ...
                            <div className="grid m-0 p-0 mb-1">
                                ...
                                <Calendar
                                    ...
                                    name='dateTo'
                                    value={dateTo}
                                    onChange={(e:any) => { console.log(e.value); setDateTo(e.value) }}
