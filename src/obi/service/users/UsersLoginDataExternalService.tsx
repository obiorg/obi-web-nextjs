...
import { UsersLoginDataExternalModel } from "../../models/users/UsersLoginDataExternalModel";




// Define the shape of the form errors UsersLoginDataExternal
interface UsersLoginDataExternalFormErrors {
    id?: string[];
    deleted?: string[];
    created?: string[];
    changed?: string[];
...
interface UsersLoginDataExternalFormState {
    errors: UsersLoginDataExternalFormErrors;
}

// Define the props that the PostForm component expects
interface UsersLoginDataExternalPostFormProps {
...
interface UsersLoginDataExternalPostFormState {
    errors: {
        id?: string[];
        deleted?: string[];
        created?: string[];
...
export const UsersLoginDataExternalService = {
    ...
    async getLazy(lazy: any): Promise<any> {
        const url = process.env.httpPath + '/users/logindataexternal/lazy/' + lazy.lazyEvent;
    ...
    async getLazyCount(lazy: any) {
        const url = process.env.httpPath + '/users/logindataexternal/lazy/count/' + lazy.lazyEvent;
        try {
            const res = await fetch(url, { headers: { 'Cache-Control': 'no-cache' } })
            if (res.ok) {
    ...
    async getById(id: any) {
        const url = process.env.httpPath + '/users/logindataexternal/' + id;
        try {
            const res = await fetch(url, { headers: { 'Cache-Control': 'no-cache' } })
            if (res.ok) {
                const val = await res.json();
    ...
    defaultMultiSortMeta(): any {
        const model = new UsersLoginDataExternalModel();
     ...
     */
    async create(
        formState: UsersLoginDataExternalFormState,
        formData: FormData | any): Promise<UsersLoginDataExternalFormState> {
        ...
        const url = process.env.httpPath + '/users/logindataexternal';
        ...
        const dataset: UsersLoginDataExternalFormState = await res.json();
        return dataset;
    ...
    async processAll(formState: any, datas: any): Promise<any> {
        ...
        datas.forEach((row:any, index:any) => {
            UsersLoginDataExternalService.create(formState, row).then((res_row) => {
    ...
    async createMany(data: any[]): Promise<any[]> {
        ...
        const url = process.env.httpPath + '/users/logindataexternal/create';
    ...
    async update(
        ...
        const url = process.env.httpPath + '/users/logindataexternal/' + data.id;
    ...
    async updateMany(
        ...
        const url = process.env.httpPath + '/users/logindataexternal/update';
        // console.log(data);
        const res = await fetch(
            url,
            {
    ...
    async delete(id: any): Promise<UsersLoginDataExternalFormState> {
    ...
    async deleteMany(
        ...
        const url = process.env.httpPath + '/users/logindataexternal/delete';
        // console.log(data);
        const res = await fetch(
            url,
            {
    ...
    async download(lazy: any): Promise<any[]> {
        const url = process.env.httpPath + '/users/logindataexternal/download/' + lazy.lazyEvent;
        const res = await fetch(url, { headers: { 'Cache-Control': 'no-cache' } })
        const dataset: any[] = await res.json();
        return dataset;
    },
