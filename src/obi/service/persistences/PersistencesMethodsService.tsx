...
export const PersistencesMethodsService = {
    ...
    async getLazy(lazy: any): Promise<any> {
        const url = process.env.httpPath + '/persistences/methods/lazy/' + lazy.lazyEvent;
    ...
    async getLazyCount(lazy: any) {
        const url = process.env.httpPath + '/persistences/methods/lazy/count/' + lazy.lazyEvent;
        try {
            const res = await fetch(url, { headers: { 'Cache-Control': 'no-cache' } })
            if (res.ok) {
    ...
    async getById(id: any) {
        const url = process.env.httpPath + '/persistences/methods/' + id;
        try {
            const res = await fetch(url, { headers: { 'Cache-Control': 'no-cache' } })
            if (res.ok) {
                const val = await res.json();
    ...
    async create(
        ...
        formData: FormData | any): Promise<PersistencesMethodsFormState> {
        ...
        const url = process.env.httpPath + '/persistences/methods';
    ...
    async createMany(data: any[]): Promise<any[]> {
        ...
        const url = process.env.httpPath + '/persistences/methods/create';
    ...
    async update(
        ...
        const url = process.env.httpPath + '/persistences/methods/' + data.id;
    ...
    async updateMany(
        ...
        const url = process.env.httpPath + '/persistences/methods/update';
        // console.log(data);
        const res = await fetch(
            url,
            {
    ...
    async deleteMany(
        ...
        const url = process.env.httpPath + '/persistences/methods/delete';
        // console.log(data);
        const res = await fetch(
            url,
            {
    ...
    async download(lazy: any): Promise<any[]> {
        const url = process.env.httpPath + '/persistences/methods/download/' + lazy.lazyEvent;
        const res = await fetch(url, { headers: { 'Cache-Control': 'no-cache' } })
        const dataset: any[] = await res.json();
        return dataset;
    },
