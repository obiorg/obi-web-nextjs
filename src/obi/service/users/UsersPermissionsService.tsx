...
import { UsersPermissionsModel } from "../../models/users/UsersPermissionsModel";




// Define the shape of the form errors UsersPermissions
interface UsersPermissionsFormErrors {
    id?: string[];
    deleted?: string[];
    created?: string[];
    changed?: string[];
...
interface UsersPermissionsFormState {
    errors: UsersPermissionsFormErrors;
}

// Define the props that the PostForm component expects
interface UsersPermissionsPostFormProps {
...
interface UsersPermissionsPostFormState {
    errors: {
        id?: string[];
        deleted?: string[];
        created?: string[];
...
export const UsersPermissionsService = {
    ...
    async getLazy(lazy: any): Promise<any> {
        const url = process.env.httpPath + '/users/permissions/lazy/' + lazy.lazyEvent;
    ...
    async getLazyCount(lazy: any) {
        const url = process.env.httpPath + '/users/permissions/lazy/count/' + lazy.lazyEvent;
        try {
            const res = await fetch(url, { headers: { 'Cache-Control': 'no-cache' } })
            if (res.ok) {
    ...
    async getById(id: any) {
        const url = process.env.httpPath + '/users/permissions/' + id;
        try {
            const res = await fetch(url, { headers: { 'Cache-Control': 'no-cache' } })
            if (res.ok) {
                const val = await res.json();
    ...
    defaultMultiSortMeta(): any {
        const model = new UsersPermissionsModel();
     ...
     */
    async create(
        formState: UsersPermissionsFormState,
        formData: FormData | any): Promise<UsersPermissionsFormState> {
        ...
        const url = process.env.httpPath + '/users/permissions';
        ...
        const dataset: UsersPermissionsFormState = await res.json();
        return dataset;
    ...
    async processAll(formState: any, datas: any): Promise<any> {
        ...
        datas.forEach((row:any, index:any) => {
            UsersPermissionsService.create(formState, row).then((res_row) => {
    ...
    async createMany(data: any[]): Promise<any[]> {
        ...
        const url = process.env.httpPath + '/users/permissions/create';
    ...
    async update(
        ...
        const url = process.env.httpPath + '/users/permissions/' + data.id;
    ...
    async updateMany(
        ...
        const url = process.env.httpPath + '/users/permissions/update';
        // console.log(data);
        const res = await fetch(
            url,
            {
    ...
    async delete(id: any): Promise<UsersPermissionsFormState> {
    ...
    async deleteMany(
        ...
        const url = process.env.httpPath + '/users/permissions/delete';
        // console.log(data);
        const res = await fetch(
            url,
            {
    ...
    async download(lazy: any): Promise<any[]> {
        const url = process.env.httpPath + '/users/permissions/download/' + lazy.lazyEvent;
        const res = await fetch(url, { headers: { 'Cache-Control': 'no-cache' } })
        const dataset: any[] = await res.json();
        return dataset;
    },
