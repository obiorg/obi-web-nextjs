...
import { EquipementsDataExternalModel } from "../../models/maintenance/EquipementsDataExternalModel";




    // Define the shape of the form errors EquipementsDataExternal
    interface EquipementsDataExternalFormErrors {
        id?: string[];
        deleted?: string[];
        created?: string[];
        changed?: string[];
    ...
    interface EquipementsDataExternalFormState {
        errors: EquipementsDataExternalFormErrors;
    }

    // Define the props that the PostForm component expects
    interface EquipementsDataExternalPostFormProps {
    ...
    interface EquipementsDataExternalPostFormState {
        errors: {
            id?: string[];
            deleted?: string[];
            created?: string[];
...
export const EquipementsDataExternalService = {
    ...
    async getLazy(lazy: any): Promise<any> {
        const url = process.env.httpPath + '/maintenance/equipementsDataExternal/lazy/' + lazy.lazyEvent;
    ...
    async getLazyCount(lazy: any) {
        const url = process.env.httpPath + '/maintenance/equipementsDataExternal/lazy/count/' + lazy.lazyEvent;
        try {
            const res = await fetch(url, { headers: { 'Cache-Control': 'no-cache' } })
            if (res.ok) {
    ...
    async getById(id: any) {
        const url = process.env.httpPath + '/maintenance/equipementsDataExternal/' + id;
        try {
            const res = await fetch(url, { headers: { 'Cache-Control': 'no-cache' } })
            if (res.ok) {
                const val = await res.json();
    ...
    defaultMultiSortMeta(): any {
        const model = new EquipementsDataExternalModel();
     ...
     */
    async create(
        formState: EquipementsDataExternalFormState,
        formData: FormData | any): Promise<EquipementsDataExternalFormState> {
        ...
        const dataset: EquipementsDataExternalFormState = await res.json();
        return dataset;
    ...
    async processAll(formState: any, datas: any): Promise<any> {
        ...
        datas.forEach((row:any, index:any) => {
            EquipementsDataExternalService.create(formState, row).then((res_row) => {
    ...
    async createMany(data: any[]): Promise<any[]> {
        ...
        const url = process.env.httpPath + '/maintenance/equipementsDataExternal/create';
    ...
    async update(
        ...
        const url = process.env.httpPath + '/maintenance/equipementsDataExternal/' + data.id;
    ...
    async updateMany(
        ...
        const url = process.env.httpPath + '/maintenance/equipementsDataExternal/update';
        // console.log(data);
        const res = await fetch(
            url,
            {
    ...
    async delete(id: any): Promise<EquipementsDataExternalFormState> {
    ...
    async deleteMany(
        ...
        const url = process.env.httpPath + '/maintenance/equipementsDataExternal/delete';
        // console.log(data);
        const res = await fetch(
            url,
            {
    ...
    async download(lazy: any): Promise<any[]> {
        const url = process.env.httpPath + '/maintenance/equipementsDataExternal/download/' + lazy.lazyEvent;
        const res = await fetch(url, { headers: { 'Cache-Control': 'no-cache' } })
        const dataset: any[] = await res.json();
        return dataset;
    },
