...
import { Admin } from '@/src/types/demos/admin';
...
const Drivers = () => {
    ...
    const defaultMultiSortMeta: Array<DataTableSortMeta> = MachinesDriversService.defaultMultiSortMeta();
    ...
    const loadLazyData = () => {
        ...
        loadLazyTimeout = setTimeout(() => {
            ...
            // Get Lazy Data
            MachinesDriversService.getLazy(lazyEventSet).then((data) => {
                // On Good request process data count
                MachinesDriversService.getLazyCount(lazyEventSet).then((dataCount) => {
