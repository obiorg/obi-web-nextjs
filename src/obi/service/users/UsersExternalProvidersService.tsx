...
import { UsersExternalProvidersModel } from "../../models/users/UsersExternalProvidersModel";




    // Define the shape of the form errors UsersExternalProviders
    interface UsersExternalProvidersFormErrors {
        id?: string[];
        deleted?: string[];
        created?: string[];
        changed?: string[];
    ...
    interface UsersExternalProvidersFormState {
        errors: UsersExternalProvidersFormErrors;
    }

    // Define the props that the PostForm component expects
    interface UsersExternalProvidersPostFormProps {
    ...
    interface UsersExternalProvidersPostFormState {
        errors: {
            id?: string[];
            deleted?: string[];
            created?: string[];
...
export const UsersExternalProvidersService = {
    ...
    async getLazy(lazy: any): Promise<any> {
        const url = process.env.httpPath + '/users/externalproviders/lazy/' + lazy.lazyEvent;
    ...
    async getLazyCount(lazy: any) {
        const url = process.env.httpPath + '/users/externalproviders/lazy/count/' + lazy.lazyEvent;
        try {
            const res = await fetch(url, { headers: { 'Cache-Control': 'no-cache' } })
            if (res.ok) {
    ...
    async getById(id: any) {
        const url = process.env.httpPath + '/users/externalproviders/' + id;
        try {
            const res = await fetch(url, { headers: { 'Cache-Control': 'no-cache' } })
            if (res.ok) {
                const val = await res.json();
    ...
    defaultMultiSortMeta(): any {
        const model = new UsersExternalProvidersModel();
     ...
     */
    async create(
        formState: UsersExternalProvidersFormState,
        formData: FormData | any): Promise<UsersExternalProvidersFormState> {
        ...
        const url = process.env.httpPath + '/users/externalproviders';
        ...
        const dataset: UsersExternalProvidersFormState = await res.json();
        return dataset;
    ...
    async processAll(formState: any, datas: any): Promise<any> {
        ...
        datas.forEach((row:any, index:any) => {
            UsersExternalProvidersService.create(formState, row).then((res_row) => {
    ...
    async createMany(data: any[]): Promise<any[]> {
        ...
        const url = process.env.httpPath + '/users/externalproviders/create';
    ...
    async update(
        ...
        const url = process.env.httpPath + '/users/externalproviders/' + data.id;
    ...
    async updateMany(
        ...
        const url = process.env.httpPath + '/users/externalproviders/update';
        // console.log(data);
        const res = await fetch(
            url,
            {
    ...
    async delete(id: any): Promise<UsersExternalProvidersFormState> {
    ...
    async deleteMany(
        ...
        const url = process.env.httpPath + '/users/externalproviders/delete';
        // console.log(data);
        const res = await fetch(
            url,
            {
    ...
    async download(lazy: any): Promise<any[]> {
        const url = process.env.httpPath + '/users/externalproviders/download/' + lazy.lazyEvent;
        const res = await fetch(url, { headers: { 'Cache-Control': 'no-cache' } })
        const dataset: any[] = await res.json();
        return dataset;
    },
