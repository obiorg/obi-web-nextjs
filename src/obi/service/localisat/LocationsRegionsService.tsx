...
import { LocationsRegionsModel } from "../../models/localisations/LocationsRegionsModel";




    // Define the shape of the form errors LocationsRegions
    interface LocationsRegionsFormErrors {
        id?: string[];
        deleted?: string[];
        created?: string[];
        changed?: string[];
    ...
    interface LocationsRegionsFormState {
        errors: LocationsRegionsFormErrors;
    }

    // Define the props that the PostForm component expects
    interface LocationsRegionsPostFormProps {
    ...
    interface LocationsRegionsPostFormState {
        errors: {
            id?: string[];
            deleted?: string[];
            created?: string[];
...
export const LocationsRegionsService = {
    ...
    async getLazy(lazy: any): Promise<any> {
        const url = process.env.httpPath + '/localisations/regions/lazy/' + lazy.lazyEvent;
    ...
    async getLazyCount(lazy: any) {
        const url = process.env.httpPath + '/localisations/regions/lazy/count/' + lazy.lazyEvent;
        try {
            const res = await fetch(url, { headers: { 'Cache-Control': 'no-cache' } })
            if (res.ok) {
    ...
    async getById(id: any) {
        const url = process.env.httpPath + '/localisations/regions/' + id;
        try {
            const res = await fetch(url, { headers: { 'Cache-Control': 'no-cache' } })
            if (res.ok) {
                const val = await res.json();
    ...
    defaultMultiSortMeta(): any {
        const model = new LocationsRegionsModel();
     ...
     */
    async create(
        formState: LocationsRegionsFormState,
        formData: FormData | any): Promise<LocationsRegionsFormState> {
        ...
        const url = process.env.httpPath + '/localisations/regions';
        ...
        const dataset: LocationsRegionsFormState = await res.json();
        return dataset;
    ...
    async processAll(formState: any, datas: any): Promise<any> {
        ...
        datas.forEach((row:any, index:any) => {
            LocationsRegionsService.create(formState, row).then((res_row) => {
    ...
    async createMany(data: any[]): Promise<any[]> {
        ...
        const url = process.env.httpPath + '/localisations/regions/create';
    ...
    async update(
        ...
        const url = process.env.httpPath + '/localisations/regions/' + data.id;
    ...
    async updateMany(
        ...
        const url = process.env.httpPath + '/localisations/regions/update';
        // console.log(data);
        const res = await fetch(
            url,
            {
    ...
    async delete(id: any): Promise<LocationsRegionsFormState> {
    ...
    async deleteMany(
        ...
        const url = process.env.httpPath + '/localisations/regions/delete';
        // console.log(data);
        const res = await fetch(
            url,
            {
    ...
    async download(lazy: any): Promise<any[]> {
        const url = process.env.httpPath + '/localisations/regions/download/' + lazy.lazyEvent;
        const res = await fetch(url, { headers: { 'Cache-Control': 'no-cache' } })
        const dataset: any[] = await res.json();
        return dataset;
    },
