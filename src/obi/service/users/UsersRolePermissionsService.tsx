...
import { UsersRolePermissionsModel } from "../../models/users/UsersRolePermissionsModel";




    // Define the shape of the form errors UsersRolePermissions
    interface UsersRolePermissionsFormErrors {
        id?: string[];
        deleted?: string[];
        created?: string[];
        changed?: string[];
    ...
    interface UsersRolePermissionsFormState {
        errors: UsersRolePermissionsFormErrors;
    }

    // Define the props that the PostForm component expects
    interface UsersRolePermissionsPostFormProps {
    ...
    interface UsersRolePermissionsPostFormState {
        errors: {
            id?: string[];
            deleted?: string[];
            created?: string[];
...
export const UsersRolePermissionsService = {
    ...
    async getLazy(lazy: any): Promise<any> {
        const url = process.env.httpPath + '/users/rolepermissions/lazy/' + lazy.lazyEvent;
    ...
    async getLazyCount(lazy: any) {
        const url = process.env.httpPath + '/users/rolepermissions/lazy/count/' + lazy.lazyEvent;
        try {
            const res = await fetch(url, { headers: { 'Cache-Control': 'no-cache' } })
            if (res.ok) {
    ...
    async getById(id: any) {
        const url = process.env.httpPath + '/users/rolepermissions/' + id;
        try {
            const res = await fetch(url, { headers: { 'Cache-Control': 'no-cache' } })
            if (res.ok) {
                const val = await res.json();
    ...
    defaultMultiSortMeta(): any {
        const model = new UsersRolePermissionsModel();
     ...
     */
    async create(
        formState: UsersRolePermissionsFormState,
        formData: FormData | any): Promise<UsersRolePermissionsFormState> {
        ...
        const url = process.env.httpPath + '/users/rolepermissions';
        ...
        const dataset: UsersRolePermissionsFormState = await res.json();
        return dataset;
    ...
    async processAll(formState: any, datas: any): Promise<any> {
        ...
        datas.forEach((row:any, index:any) => {
            UsersRolePermissionsService.create(formState, row).then((res_row) => {
    ...
    async createMany(data: any[]): Promise<any[]> {
        ...
        const url = process.env.httpPath + '/users/rolepermissions/create';
    ...
    async update(
        ...
        const url = process.env.httpPath + '/users/rolepermissions/' + data.id;
    ...
    async updateMany(
        ...
        const url = process.env.httpPath + '/users/rolepermissions/update';
        // console.log(data);
        const res = await fetch(
            url,
            {
    ...
    async delete(id: any): Promise<UsersRolePermissionsFormState> {
    ...
    async deleteMany(
        ...
        const url = process.env.httpPath + '/users/rolepermissions/delete';
        // console.log(data);
        const res = await fetch(
            url,
            {
    ...
    async download(lazy: any): Promise<any[]> {
        const url = process.env.httpPath + '/users/rolepermissions/download/' + lazy.lazyEvent;
        const res = await fetch(url, { headers: { 'Cache-Control': 'no-cache' } })
        const dataset: any[] = await res.json();
        return dataset;
    },
